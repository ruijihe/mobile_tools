var Fe=Object.defineProperty;var Le=(a,o,e)=>o in a?Fe(a,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[o]=e;var F=(a,o,e)=>(Le(a,typeof o!="symbol"?o+"":o,e),e);import{g as De}from"./main-52f297a4.js";import"./index-9591f051.js";const T={MESSAGE:"message",SUCCESS:"success",ERROR:"error",WARNING:"warning"},le={MESSAGE:"icon-zhengque iconfont",SUCCESS:"icon-zhengque iconfont",ERROR:"icon-cuowu iconfont",WARNING:"icon-shizhi iconfont"},H={MESSAGE:"#909399",SUCCESS:"#67c23a",ERROR:"#f56c6c",WARNING:"#e6a23c"},K=({isId:a=!1,name:o="",tag:e=""})=>{if(!e)return null;const t=document.createElement(e);return o&&(a?t.id=o:t.className=o),t},Z=a=>{let o="";switch(a){case T.SUCCESS:o="background-color:#f0f9eb";break;case T.ERROR:o="background-color:#fef0f0";break;case T.WARNING:o="background-color: #fdf6ec";break;default:o="background-color: #edf2fc";break}return o},Te=a=>{let o="",e="";switch(a){case T.SUCCESS:o=e+`${Z(a)};color: ${H.SUCCESS};display:flex;`;break;case T.ERROR:o=e+`${Z(a)};color: ${H.ERROR};display:flex;`;break;case T.WARNING:o=e+`${Z(a)};color: ${H.WARNING};display:flex;`;break;default:o=e+`${Z(a)};color: ${H.MESSAGE};display:flex;`;break}return o},Oe=a=>{let o="";switch(a){case T.SUCCESS:o=le.SUCCESS;break;case T.ERROR:o=le.ERROR;break;case T.WARNING:o=le.WARNING;break;default:o=le.MESSAGE;break}return o},Re=a=>{let o="",e="margin-right: 10px;font-size: 20px;";switch(a){case T.SUCCESS:o=e+`color: ${H.SUCCESS};`;break;case T.ERROR:o=e+`color: ${H.ERROR};`;break;case T.WARNING:o=e+`color: ${H.WARNING};`;break;default:o=e+`color: ${H.MESSAGE};`;break}return o},Ie=({type:a,content:o,duration:e,delay:t,agaiBtn:s,minWidth:n,maxWidth:l},r)=>{if(!r){console.log("error!!!!");return}const c=Math.floor(Math.random()*(99999-10002))+10002,d={isRemove:!1,type:a||T.MESSAGE,content:o||"",duration:e||3e3,delay:t||0,timeout:null,agaiBtn:s||!1},p=K({name:`message-${c}`,tag:"div"});p.style=`
    min-width:${n}px;
    max-width:${l}px;
    padding:12px;
    margin-top:-40px;
  ...
  pointer-events: auto;
  overflow:hidden;
    `;const u=K({tag:"div"});u.style=Te(d.type);const m=K({name:`${Oe(d.type)}`,tag:"div"});m.style=Re(d.type);const g=K({tag:"span"});if(g.style="font-size: 14px;line-height:20px;",g.innerHTML=d.content,u.appendChild(m),u.appendChild(g),p.appendChild(u),d.agaiBtn){const y=K({name:"message-again-btn",tag:"div"});y.style="margin-top: 5px;text-align:right;";const P=K({name:"message-again-text",tag:"span"});P.innerHTML="不再提示",P.style=`
        font-size: 12px;
        color: rgb(204, 201, 201);
        border-bottom: 1px solid rgb(204, 201, 201);
        cursor: pointer;
        `,P.onmouseover=()=>{P.style.color="#fdb906",P.style.borderBottom="1px solid #fdb906"},P.onmouseout=()=>{P.style.color="rgb(204, 201, 201)",P.style.borderBottom="1px solid rgb(204, 201, 201)"},y.appendChild(P),p.appendChild(y),d.elsAgainBtn=P}r.appendChild(p),d.els=p,d.destory=f.bind(globalThis);function f(y,P){!d.els||!y||d.isRemove||(d.els.style.marginTop="-20px",d.els.style.opacity="0",d.isRemove=!0,P?(y.removeChild(p),_e(y),_()):setTimeout(()=>{y.removeChild(p),_e(y),_()},400))}function _(){d.els=null,d.elsAgainBtn=null,d.destory=null}return d};function ze(a,o){a&&(a.agaiBtn&&a.elsAgainBtn&&(a.elsAgainBtn.onclick=()=>{clearTimeout(a.timeout);let e=sessionStorage.getItem("MESSAGE_DONT_REMIND_AGAIN"),t=e?JSON.parse(e):[],s=Array.isArray(t)?t:[];s.push(a.content),sessionStorage.setItem(o.sessionStorageName,JSON.stringify(s)),a.destory(o.mainContainer,!0)}),a.els.onmouseover=()=>{clearTimeout(a.timeout)},a.els.onmouseout=()=>{a.timeout=setTimeout(()=>{a.destory(o.mainContainer),clearTimeout(a.timeout)},1e3)},a.timeout=setTimeout(()=>{a.destory(o.mainContainer),clearTimeout(a.timeout)},a.duration))}function _e(a){a&&(a.style.left=`calc(50vw - ${a.scrollWidth/2}px)`)}class ke{constructor(){this.minWidth=380,this.maxWidth=800,this.top=90,this.zIndex=999,this.mainContainerIdName="selfDefine-message-box",this.sessionStorageName="MESSAGE_DONT_REMIND_AGAIN";let o=document.getElementById(this.mainContainerIdName);o&&document.body.removeChild(o),this.mainContainer=K({isId:!0,name:this.mainContainerIdName,tag:"div"}),this.mainContainer.style=`
      pointer-events:none;
      position:fixed;
      top:${this.top}px;
      ...
      align-items:center;
      `,document.body.appendChild(this.mainContainer)}message(o={}){let e=sessionStorage.getItem(this.sessionStorageName),t=e?JSON.parse(e):null;if(o.againBtn&&o.content&&t&&Array.isArray(t)&&t.includes(o.content))return;const s=Ie({type:o.type,content:o.content,duration:o.duration,delay:o.delay,againBtn:o.againBtn,minWidth:this.minWidth,maxWidth:this.maxWidth},this.mainContainer);this.mainContainer.appendChild(s.els),s.els.style.marginTop="20px",_e(this.mainContainer),ze(s,this)}beforeDestory(){this.mainContainer&&this.mainContainer.remove?this.mainContainer.remove():document.body.removeChild(this.mainContainer),this.mainContainer=null}}class qe{constructor(o){this.boxHtml=document.createElement("div"),this.boxHtml.className="black_box",this.boxHtml.style.display="none",o.uiPanelBox.dom.appendChild(this.boxHtml),this.editor=o}setVal(o){let e=document.getElementsByClassName("black_box")[0];e.style.display="block",e.style=`top:${o.top}px;left:${o.left}px;position:absolute;`,e.innerHTML=`<span>${typeof o.value=="number"?o.value+"°":o.value}</span>`}removeDom(){let o=document.getElementsByClassName("black_box")[0];o&&this.editor.uiPanelBox.dom.removeChild(o)}}class je{constructor(o){this.ele=o,this.downFn()}downFn(){this.ele.onmousedown=o=>{let e=o||window.event,t=e.clientX-this.ele.offsetLeft,s=e.clientY-this.ele.offsetTop;this.moveFn(t,s),this.upFn()}}moveFn(o,e){this.ele.onmousemove=t=>{let s=t||window.event,n=s.clientX,l=s.clientY;this.setStyle(n-o,l-e)}}setStyle(o,e){o=o<0?0:o,e=e<0?0:e,this.ele.style.left=o+"px",this.ele.style.top=e+"px"}upFn(){this.ele.onmouseup=()=>{this.ele.onmousemove=""}}}class ve{constructor(o){this.opts=Object.assign({width:"30%",height:"200px",title:"标题",content:"内容",dragable:!1,maskable:!0,isCancel:!0,success(){editor.list.doCallback.dispatch(o.param)},cancel(){console.log("点击取消按钮处理逻辑")}},o),this.init()}init(){this.renderView(),this.dialogHtml.onclick=o=>{switch(o.target.className){case"rjh_close":this.close(),this.opts.cancel();break;case"rjh_cancel":this.close(),this.opts.cancel();break;case"rjh_primary":this.confim(),this.close();break}}}confim(o){this.opts.success(o)}close(){$(".rjh_wrapper").parent().remove()}open(){if(this.opts.maskable&&(this.dialogHtml.querySelector(".rjh_wrapper").style.display="block"),this.opts.dragable){let o=this.dialogHtml.querySelector(".rjh_dialog");new je(o)}this.dialogHtml.querySelector(".rjh_dialog").style.display="block"}renderView(){this.dialogHtml=document.createElement("div"),this.dialogHtml.innerHTML=`<div class="rjh_wrapper"></div>
    ...
    `);const o=document.querySelector(".tab_boxcontent"),e=document.createElement("div");e.className="left_minicontent article_shadow ",o.appendChild(e),$(".left_minicontent").append(`<div class='left_minicontent_bigbox'>
      ...
      `);var e=document.querySelectorAll(".header_p");e.forEach((t,s)=>{const n=e[s].innerHTML;e[s].onclick=function(){switch(n){case"普通图":$(".renderChirld").addClass("none"),$(".renderContent").removeClass("none"),$(".header_p").removeClass("add_bd"),$(this).addClass("add_bd"),te.common();break;case"全景图":$(".renderChirld").addClass("none"),$(".renderContent").removeClass("none"),$(".header_p").removeClass("add_bd"),$(this).addClass("add_bd"),te.allView();break;case"俯视图":$(".renderChirld").addClass("none"),$(".renderContent").removeClass("none"),$(".header_p").removeClass("add_bd"),$(this).addClass("add_bd"),te.verticalView();break;case"漫游视频":$(".header_p").removeClass("add_bd"),$(this).addClass("add_bd"),$(".renderChirld").addClass("none"),$(".wanderDom").removeClass("none");break}}}),$(".escBtn").click(()=>{$(".contentFlag").addClass("none"),$("#plugin_container").removeClass("none"),$("#popup_content").removeClass("none"),document.documentElement.style.setProperty("--click-color","#00559D"),$(".canvas").removeClass("none"),editor.openRenderScene=!1,document.querySelector("#cameraShot_box")&&document.querySelector("#cameraShot_box").remove()})}}class eo{constructor(){this.init(),this.method()}init(){let o=[{name:"全部",class:"styleBoxClick"},{name:"现代简约",class:""},{name:"新中式",class:""},{name:"轻奢",class:""},{name:"北欧",class:""},{name:"欧式",class:""},{name:"简欧",class:""},{name:"日式",class:""},{name:"美式",class:""},{name:"简美",class:""},{name:"佗寂",class:""},{name:"原木",class:""},{name:"奶油",class:""},{name:"意式",class:""},{name:"港式",class:""},{name:"后现代",class:""},{name:"工业风",class:""},{name:"混搭",class:""},{name:"田园",class:""},{name:"地中海",class:""}],e=[{id:"16:9",class:"block ratioContent",list:[{id:1,font:"icon-duanshijian",type:"unlock",value1:"1k标清",value2:"1024*576",time:"排队耗时 00:32"},{id:2,font:"icon-duanshijian",type:"unlock",value1:"2k高清",value2:"1920*1080",time:"排队耗时 02:44"},{id:3,font:"icon-duanshijian",type:"unlock",value1:"3k超清",value2:"2560*1440",time:"排队耗时 02:36"},{id:4,font:"icon-zhangshijian",type:"lock",value1:"4k超高清",value2:"3840*2160",time:"排队耗时 02:44"},{id:5,font:"icon-zhangshijian",type:"lock",value1:"8k超高清",value2:"7680*4320",time:"排队耗时 02:44"}]},{id:"9:16",class:"none ratioContent",list:[{id:1,font:"icon-duanshijian",type:"unlock",value1:"1k标清",value2:"576*1024",time:"排队耗时 00:32"},{id:2,font:"icon-duanshijian",type:"unlock",value1:"2k高清",value2:"1080*1920",time:"排队耗时 02:44"},{id:3,font:"icon-duanshijian",type:"unlock",value1:"3k超清",value2:"1440*2560",time:"排队耗时 02:36"},{id:4,font:"icon-zhangshijian",type:"lock",value1:"4k超高清",value2:"2160*3840",time:"排队耗时 02:44"},{id:5,font:"icon-zhangshijian",type:"lock",value1:"8k超高清",value2:"4320*7680",time:"排队耗时 02:44"}]},{id:"4:3",class:"none ratioContent",list:[{id:1,font:"icon-duanshijian",type:"unlock",value1:"1k标清",value2:"1024*768",time:"排队耗时 00:32"},{id:2,font:"icon-duanshijian",type:"unlock",value1:"2k高清",value2:"1600*1200",time:"排队耗时 02:44"},{id:3,font:"icon-duanshijian",type:"unlock",value1:"3k超清",value2:"3200*2400",time:"排队耗时 02:36"},{id:4,font:"icon-zhangshijian",type:"lock",value1:"4k超高清",value2:"4000*3000",time:"排队耗时 02:44"},{id:5,font:"icon-zhangshijian",type:"lock",value1:"8k超高清",value2:"8000*6000",time:"排队耗时 02:44"}]},{id:"3:4",class:"none ratioContent",list:[{id:1,font:"icon-duanshijian",type:"unlock",value1:"1k标清",value2:"768*1024",time:"排队耗时 00:32"},{id:2,font:"icon-duanshijian",type:"unlock",value1:"2k高清",value2:"1200*1600",time:"排队耗时 02:44"},{id:3,font:"icon-duanshijian",type:"unlock",value1:"3k超清",value2:"2400*3200",time:"排队耗时 02:36"},{id:4,font:"icon-zhangshijian",type:"lock",value1:"4k超高清",value2:"3000*4000",time:"排队耗时 02:44"},{id:5,font:"icon-zhangshijian",type:"lock",value1:"8k超高清",value2:"6000*8000",time:"排队耗时 02:44"}]},{id:"1:1",class:"none ratioContent",list:[{id:1,font:"icon-duanshijian",type:"unlock",value1:"1k标清",value2:"768*768",time:"排队耗时 00:32"},{id:2,font:"icon-duanshijian",type:"unlock",value1:"2k高清",value2:"1920*1920",time:"排队耗时 02:44"},{id:3,font:"icon-duanshijian",type:"unlock",value1:"3k超清",value2:"3200*3200",time:"排队耗时 02:36"},{id:4,font:"icon-zhangshijian",type:"lock",value1:"4k超高清",value2:"3840*3840",time:"排队耗时 02:44"},{id:5,font:"icon-zhangshijian",type:"lock",value1:"8k超高清",value2:"7680*7680",time:"排队耗时 02:44"}]}],t=[{num:"16:9",class:"l_top_content_b_color"},{num:"9:16"},{num:"4:3"},{num:"3:4"},{num:"1:1"}];$(".renderContent").append(`
        ...
        `)}method(){$(".left_btn").click(()=>{te.hideOrshow()}),$(".show_btn").click(()=>{te.hideOrshow()}),$(".resolution-slc-content").click(function(){$(".resolution-slc-content").removeClass("l_top_content_b_color"),$(this).addClass("l_top_content_b_color"),console.log(this)}),$(".styleBox").click(function(){$(".styleBox").removeClass("styleBoxClick"),$(this).addClass("styleBoxClick");const o=$(this).html();let e=0;switch(o){case"全部":e=0;break;case"现代简约":e=1;break;case"新中式":e=2;break;case"轻奢":e=3;break;case"北欧":e=4;break;case"欧式":e=5;break;case"简欧":e=6;break;case"日式":e=7;break;case"美式":e=8;break;case"简美":e=9;break;case"佗寂":e=10;break;case"原木":e=11;break;case"奶油":e=12;break;case"意式":e=13;break;case"港式":e=14;break;case"后现代":e=15;break;case"工业风":e=16;break;case"混搭":e=17;break;case"田园":e=18;break;case"地中海":e=19;break}$(".styleImgContent").empty(),$(".styleImgContent").append(`
            ...
            `).join("")}
            `)}),$(".styleImg").click(function(){console.log(this)})}}class oo{constructor(){this.init(),this.method()}init(){$(".renderContent").append(`
    <!-- 右侧边栏 --> 
    ...
    `),$(".renderContent").append(`
        ...
        `)}method(){let o=document.querySelectorAll(".viewTitle");o.forEach((e,t)=>{o[t].onclick=function(){$(".viewTitle").removeClass("t_bc"),$(this).addClass("t_bc")}}),$(function(){new oe({location:".cemeraCrop"})}),$(function(){new oe({location:".cemeraRevise"})}),$(".composition_p_c").click(function(){$(".composition_p_c").removeClass("composition-style"),$(this).addClass("composition-style"),console.log(this.id);let e=this.id;(e=="noComposition"||e=="Sudoku"||e=="goldenCut")&&console.log(e)}),$(function(){$(".right_t").resizable({handles:"sw",minWidth:272,minHeight:188,maxWidth:1295})}),$(function(){$(".right_t").draggable({handle:".title_1"})}),$(function(){$(".right_content").draggable({handle:".right_content_t"})}),$(".right_t").draggable({snap:".rederRight",snapMode:"inner"}),$(".right_content").draggable({snap:".rederRight",snapMode:"inner"})}}class to{constructor(){this.init(),this.method()}init(){let o=[{id:1,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:2,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:3,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:4,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:5,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:6,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:7,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:8,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:9,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:10,src:"./static/assets/images/2400.jpg",value:"客厅空间"},{id:11,src:"./static/assets/images/2400.jpg",value:"客厅空间"}],e=[{id:1,src:"./static/assets/images/2400.jpg",value:"室内白天"},{id:2,src:"./static/assets/images/2400.jpg",value:"室内夜晚"},{id:3,src:"./static/assets/images/2400.jpg",value:"室外写实夜晚"}];$(".contentDom").append(`
...
`),$(".wanderBox").append(`
    ...
    `)}method(){const o=document.getElementById("cemeraAngle"),e=document.getElementById("cemeraHeight");o.onchange=function(){editor.list.changRenderCameraInput.dispatch("angle",parseFloat($("#cemeraAngle").val()))},e.onchange=function(){editor.list.changRenderCameraInput.dispatch("height",parseFloat($("#cemeraHeight").val()))};let t=document.querySelectorAll(".l_top_content_b");for(let u=0;u<t.length;u++)t[u].onclick=function(){$(".l_top_content_b").removeClass("l_top_content_b_color"),$(this).addClass("l_top_content_b_color"),$(".ratioContent").addClass("none"),$(".ratioContent")[u].classList.remove("none");let m=$(this).html().split(":");m[0]*=1,m[1]*=1,editor.list.renderCameraSize.dispatch(m)};$(".n_render").click(function(){editor.autoMakeRenderPng()});let s=document.querySelectorAll(".wdRatio");s.forEach((u,m)=>{s[m].onclick=function(){$(".wdRatio").removeClass("t_bc"),$(this).addClass("t_bc")}});var n=document.querySelectorAll(".wdSwitchbtn ");n.forEach((u,m)=>{n[m].onclick=function(){$(".wdSwitchbtn ").removeClass("t_bc"),$(this).addClass("t_bc"),m===0?($(".wdRealistic").removeClass("none"),$(".wdBalanced").addClass("none")):m===1&&($(".wdRealistic").addClass("none"),$(".wdBalanced").removeClass("none"))}});let l=document.querySelectorAll(".wd_switchSettingBtn");l.forEach((u,m)=>{l[m].onclick=function(){switch($(".wd_switchSettingBtn").removeClass("wd_st_bd"),$(this).addClass("wd_st_bd"),m){case 0:$(".wd_content").addClass("none"),$(".wd_st_content").removeClass("none");break;case 1:$(".wd_content").addClass("none"),$(".wd_cemera_content").removeClass("none");break}}});let r=document.querySelectorAll(".wd_img");r.forEach((u,m)=>{r[m].onclick=function(){$(".wd_img").removeClass("wd_img_bd"),$(this).addClass("wd_img_bd")}});let c=document.querySelectorAll(".wdRealistic_img");c.forEach((u,m)=>{c[m].onclick=function(){let g=this.parentNode.children[2],f=this.parentNode;m===0||m===2?$(".triangle").css("left","70px"):$(".triangle").css("left","220px"),$(".wd_photo_div").removeClass("wdMargin_b"),$(f).addClass("wdMargin_b"),$(".wdRealisticSetting").addClass("none"),$(g).removeClass("none")}});let d=document.querySelectorAll(".wdViewSwitchBtn");d.forEach((u,m)=>{d[m].onclick=function(){m===0?($(".wdView").removeClass("none"),$(".wdRoom").addClass("none")):m===1&&($(".wdView").addClass("none"),$(".wdRoom").removeClass("none")),$(".wdViewSwitchBtn").removeClass("t_bc"),$(this).addClass("t_bc")}});let p=document.querySelector(".wdCloseSettingBtn");p.onclick=function(){let u=this.parentNode.parentNode.children[1],m=!m;m===!0?$(u).removeClass("none"):$(u).addClass("none")},$(function(){new oe({location:".wdCemeraCrop"})}),$(function(){new oe({location:".wdCemeraRevise"})}),$(function(){new oe({location:".wdFocus"})}),$(function(){$(".wanderRight_t").resizable({handles:"sw",minWidth:272,minHeight:208,maxWidth:1295,maxHeight:720})}),$(function(){$(".wanderRight_t").draggable({handle:".moveWd_t"})}),$(function(){$(".wanderRight_b").draggable({handle:".moveWd_b"})}),$(".wanderRight_t").draggable({snap:".wanderDom",snapMode:"inner"}),$(".wanderRight_b").draggable({snap:".wanderDom",snapMode:"inner"})}}class so{constructor(){const o=document.querySelector("body"),e=document.createElement("div");e.setAttribute("id","ceilingDesign"),e.className="contentFlag none",o.appendChild(e);const t=document.createElement("div");t.className="ceiling_design_box",e.appendChild(t),$(".contentFlag").addClass("none"),$("#ceilingDesign").removeClass("none"),this.renderView()}init(){}renderView(){const o=document.querySelector(".ceiling_design_box"),e=document.createElement("div");e.className="ceiling_design_header",o.appendChild(e);const t=document.createElement("div");t.className="content_app",o.appendChild(t);const s=document.createElement("div");s.className="navigate_left",t.appendChild(s);const n=[{icon:"icon-fenxiang",title:"Undo"},{icon:"icon-fenxiang",title:"Redo"},{icon:"icon-fenxiang",title:"粘贴"},{icon:"icon-fenxiang",title:"3D"},{icon:"icon-fenxiang",title:"分享"},{icon:"icon-fenxiang",title:"导出"},{icon:"icon-fenxiang",title:"打印"},{icon:"icon-fenxiang",title:"项目"},{icon:"icon-fenxiang",title:"帮助"},{icon:"icon-fenxiang",title:"教程"}];$(".navigate_left").append(`
<div class='navigate_leftTop'>
${n.map(p=>` <div class="nav_item navLeft_item" data-toolType = "${p.title}">
    <span class="iconfont_app ${p.icon}"></span>
    <span class="nav_name">${p.title}</span>
    </div>`).join("")}
</div>
...
`);const l=document.querySelectorAll(".navLeft_item");for(let p=0;p<l.length;p++)l[p].onclick=function(u){let m=$(this)[0].dataset.tooltype;console.log(m)};const r=[{icon:"icon-fenxiang",title:"方形"},{icon:"icon-fenxiang",title:"L形"},{icon:"icon-fenxiang",title:"U形"},{icon:"icon-fenxiang",title:"T形"},{icon:"icon-fenxiang",title:"I形"},{icon:"icon-fenxiang",title:"S形"},{icon:"icon-fenxiang",title:"Z形"},{icon:"icon-fenxiang",title:"圆"},{icon:"icon-fenxiang",title:"弧形"},{icon:"icon-fenxiang",title:"画墙"}],c=document.createElement("div");c.className="navigate_right",t.appendChild(c),$(".navigate_right").append(`
        ${r.map(p=>`<div data-toolType = "${p.title}" class="nav_item navRight_item">
            <span class="iconfont_app ${p.icon}"></span>
            <span class="nav_name">${p.title}</span>
            </div>`).join("")}
`);const d=document.querySelectorAll(".navRight_item");for(let p=0;p<d.length;p++)d[p].onclick=function(u){let m=$(this)[0].dataset.tooltype;console.log(m)}}}const ie=class{constructor(){this.init(),new io}init(){this.renderView(),this.LogoClick(),$("#switchColor").click(ie.themeChange)}renderView(){const o=`<div class="centent_box_2 cursor" id="switchColor">
        ...
        <span>主题切换</span>
         ...
         ${window.paramsUrl.plat=="su"||window.paramsUrl.plat=="ue"?"":`<div class='logo_content'>
         ...
         <div class="footerContent_right">
           ...
           ${window.paramsUrl.plat=="su"||window.paramsUrl.plat=="ue"?"":`<div class="support">
           <svg class="icon" aria-hidden="true">
           <use xlink:href="#icon-bodi_2"></use>
           </svg>
       ...
       `),$(".footerContent_right").append(` <div class="locktool">
           ...
           ${r.map(b=>` <div class="horizontalCenter2 hidetoolpit_1 verticalCenter cursor">
               <input type="checkbox"/>
               <span>${b.title}</span>
               <img src="./static/assets/images/footer/caret-right.svg"/>
               </div>`).join("")}
       ...
       `);const d=document.getElementsByClassName("footerContent_left")[0],p=document.createElement("div");p.setAttribute("id","videoModeView"),p.className="videoMode_view",d.insertBefore(p,d.child);const u=[{icon:"icon-caizhimushi",title:"材质模式",type:"materialModel"},{icon:"icon-xiankuangmushi",title:"线框模式",type:"lineModel"},{icon:"icon-caizhijiaxiankuangmushi",title:"材质+线框模式",type:"MLModel"},{icon:"icon-shushimushi",title:"透明线框模式",type:"transparentModel"},{icon:"icon-caizhimushi",title:"随机材质模式",type:"randomMaterialModel"}];$("#videoModeView").append(`${u.map(b=>` <div class='videoMode_item  cursor' data-type = ${b.type}>
        ...
        <div class="f-a-s f-t-t">
            ...
            `),new M({title:"长度",location:".modelLenght",unit:"mm",sliderVal:`${this.opts.extent}`,sliderMax:`${o}`,sliderMin:`${s}`,valueId:"extentLenghtVal",sliderId:"extentLenght",numbertype:"width",stepVal:"10",rangeClass:"modelRange",inputClass:"modelInput",isSame:!1}),new M({title:"宽度",location:".modelWidth",unit:"mm",sliderVal:`${this.opts.width}`,sliderMax:`${e}`,sliderMin:`${n}`,valueId:"widthLenghtVal",sliderId:"widthLenght",numbertype:"width",stepVal:"10",rangeClass:"modelRange",inputClass:"modelInput",isSame:!1}),new M({title:"高度",location:".modelheight",unit:"mm",sliderVal:`${this.opts.height}`,sliderMax:`${t}`,sliderMin:`${l}`,valueId:"heightLenghtVal",sliderId:"heightLenght",numbertype:"width",stepVal:"10",rangeClass:"modelRange",inputClass:"modelInput",isSame:!1}),new M({title:"离地距离",location:".modelTakeoff",unit:"mm",sliderVal:`${this.opts.takeOff}`,sliderMax:"2800",sliderMin:"0",valueId:"bridgeLenghtVal",sliderId:"takeOffLenght",numbertype:"width",rangeClass:"TakeoffInput",inputClass:"TakeoffInput"})}event(){let o=document.querySelectorAll(".modelRange"),e=document.querySelectorAll(".modelInput"),t=document.querySelectorAll(".TakeoffInput"),s=this.opts.extent,n=this.opts.width,l=this.opts.height;$(function(){let g=$("#rotateInput-x").val(),f=$("#rotateInput-y").val(),_=$("#rotateInput-z").val(),y=-g+360,P=-f+360,j=-_+360;$("#input-dial-x").css("transform","rotate("+y+"deg)"),$("#input-dial-y").css("transform","rotate("+P+"deg)"),$("#input-dial-z").css("transform","rotate("+j+"deg)");for(let N=0;N<o.length;N++)o[N].oninput=C=>{let k=N,E=C.target.id,w=C.target.valueAsNumber,v=document.querySelector(".modelScale").checked,h=[];if(v){if(E=="extentLenght"){let S=parseInt(w/s*n),D=parseInt(w/s*l);h=[w,S,D]}else if(E=="widthLenght"){let S=parseInt(w/n*s),D=parseInt(w/n*l);h=[S,w,D]}else if(E=="heightLenght"){let S=parseInt(w/l*s),D=parseInt(w/l*n);h=[S,D,w]}$("#extentLenghtVal").val(h[0]),$("#widthLenghtVal").val(h[1]),$("#heightLenghtVal").val(h[2]),$("#extentLenght").val(h[0]),$("#widthLenght").val(h[1]),$("#heightLenght").val(h[2])}else{let S=document.querySelectorAll(".modelInput");for(let D=0;D<S.length;D++)S[k].value=w;h=[$("#extentLenght").val(),$("#widthLenght").val(),$("#heightLenght").val()]}editor.list.change2DModelParam.dispatch("size",h)};for(let N=0;N<e.length;N++)e[N].onblur=C=>{let k=N,E=C.target.id,w=C.target.valueAsNumber,v=document.querySelector(".modelScale").checked,h=[];if(v){if(E=="extentLenghtVal"){let S=parseInt(w/s*n),D=parseInt(w/s*l);h=[w,S,D]}else if(E=="widthLenghtVal"){let S=parseInt(w/n*s),D=parseInt(w/n*l);h=[S,w,D]}else if(E=="heightLenghtVal"){let S=parseInt(w/l*n);h=[parseInt(w/l*s),S,w]}$("#extentLenghtVal").val(h[0]),$("#widthLenghtVal").val(h[1]),$("#heightLenghtVal").val(h[2]),$("#extentLenght").val(h[0]),$("#widthLenght").val(h[1]),$("#heightLenght").val(h[2])}else{let S=document.querySelectorAll(".modelRange");for(let D=0;D<S.length;D++)S[k].value=w;h=[$("#extentLenghtVal").val(),$("#widthLenghtVal").val(),$("#heightLenghtVal").val()]}editor.list.change2DModelParam.dispatch("size",h)},e[N].onkeydown=C=>{C.keyCode===13&&e[N].blur()};for(let N=0;N<t.length;N++)t[N].oninput=C=>{let k=C.target.valueAsNumber;$("#bridgeLenghtVal").val(k),$("#takeOffLenght").val(k),editor.list.change2DModelParam.dispatch("floorHei",k)}}),document.querySelectorAll(".input-dial");let r=document.querySelectorAll(".rotateInput"),c="",d="";$(".input-dial").mousedown(function(g){let f=g.target.id;f=="input-dial-x"||f=="input-dial-pointer-x"?(c="input-dial-x",d="rotateInput-x"):f=="input-dial-y"||f=="input-dial-pointer-y"?(c="input-dial-y",d="rotateInput-y"):(f=="input-dial-z"||f=="input-dial-pointer-z")&&(c="input-dial-z",d="rotateInput-z"),document.addEventListener("mousemove",u),document.addEventListener("mouseup",p)});function p(){document.removeEventListener("mousemove",u),document.removeEventListener("mouseup",p)}function u(g){let f=document.getElementById(c).getBoundingClientRect(),{x:_,y,width:P,height:j}=f,N=_+P/2,C=y+j/2,k=g.pageX,E=g.pageY,w=[k-N,E-C],v=Math.atan2(w[1],w[0])*180/Math.PI;v=parseInt(v<0?v+360:v),$(`#${c}`).css("transform","rotate("+v+"deg)"),$(`#${d}`).val(-(v-360));let h=[];h.push($("#rotateInput-x").val()),h.push($("#rotateInput-y").val()),h.push($("#rotateInput-z").val()),editor.list.change2DModelParam.dispatch("rotation",h)}for(let g=0;g<r.length;g++)r[g].onblur=function(f){let _=-this.value+360;g==0?c="input-dial-x":g==1?c="input-dial-y":g==2&&(c="input-dial-z"),this.value>360&&(this.value=360),$(`#${c}`).css("transform","rotate("+_+"deg)");let y=[];y.push($("#rotateInput-x").val()),y.push($("#rotateInput-y").val()),y.push($("#rotateInput-z").val()),editor.list.change2DModelParam.dispatch("rotation",y)},r[g].onkeydown=function(f){if(f.keyCode===13){let _=-this.value+360;g==0?c="input-dial-x":g==1?c="input-dial-y":g==2&&(c="input-dial-z"),this.value>360&&(this.value=360),$(`#${c}`).css("transform","rotate("+_+"deg)");let y=[];y.push($("#rotateInput-x").val()),y.push($("#rotateInput-y").val()),y.push($("#rotateInput-z").val()),editor.list.change2DModelParam.dispatch("rotation",y)}};let m=this;$(".resetModel").click(function(){let g=[m.opts.oldExtent,m.opts.oldWidth,m.opts.oldHeight];$("#extentLenghtVal").val(g[0]),$("#widthLenghtVal").val(g[1]),$("#heightLenghtVal").val(g[2]),$("#extentLenght").val(g[0]),$("#widthLenght").val(g[1]),$("#heightLenght").val(g[2]),$("#bridgeLenghtVal").val(m.opts.oldFloorHei),$("#takeOffLenght").val(m.opts.oldFloorHei),$(".input-dial").css("transform","rotate(0deg)"),$(".rotateInput").val(0),editor.list.change2DModelParam.dispatch("size",g),editor.list.change2DModelParam.dispatch("floorHei",m.opts.oldFloorHei),editor.list.change2DModelParam.dispatch("rotation",[0,0,0])})}}class Pe{constructor(o){this.opts=Object.assign({keys:"",title:"",extent:null,extentMax:null,width:null,widthMax:null,height:null,heightMax:null,takeOff:null,angle:null},o);const e=document.querySelectorAll(".public_property");for(let n=0;n<e.length;n++){const l=e[n];l.parentNode.removeChild(l)}const t=document.getElementsByClassName("property")[0];var s=document.createElement("div");s.setAttribute("id","bridge"),s.className="public_property",t.insertBefore(s,t.child),this.init()}init(){this.renderView(),this.event()}renderView(){$("#bridge").append(`<div class="header">
          <svg
            height="1em"
            viewBox="0 0 5 14"
            width="1em"
      ...
      <button class="recover_default">恢复默认</button>
        ...
        `),new M({title:"长度",location:".doorlength",unit:"mm",sliderVal:`${this.opts.extent}`,sliderMax:"2800",sliderMin:"1",valueId:"doorLenghtVal",sliderId:"doorLenght",numbertype:"width"}),new M({title:"高度",location:".doorHeight",unit:"mm",sliderVal:`${this.opts.height}`,sliderMax:"20000",sliderMin:"1",valueId:"doorHeightVal",sliderId:"doorHeight",numbertype:"height"}),new M({title:"厚度",location:".doorply",unit:"mm",sliderVal:`${this.opts.ply}`,sliderMax:"1500",sliderMin:"1",valueId:"doorPlyVal",sliderId:"doorPly",numbertype:"depth"}),new M({title:"离地",location:".lidi",unit:"mm",sliderVal:`${this.opts.takeOff}`,sliderMax:"2800",sliderMin:"0",valueId:"doorLiftoffVal",sliderId:"doorLiftoff",numbertype:"floorHei"})}commondoor(){$("#commonDoor").click(()=>{console.log("普通门")}),$("#doubleDoor").click(()=>{console.log("双开门")}),$("#slidingDoor").click(()=>{console.log("移门")})}}const $e=new q,fe=class{constructor(){const o=document.querySelectorAll(".public_property");for(let s=0;s<o.length;s++){const n=o[s];n.parentNode.removeChild(n)}const e=document.getElementsByClassName("property")[0];var t=document.createElement("div");t.setAttribute("id","floor"),t.className="public_property",e.insertBefore(t,e.child),this.init()}init(){this.renderView(),fe.roomSelect()}renderView(){$("#floor").append(` <div class="view_header">
          ...
          `),new M({title:"套内面积",location:".inside_space",unit:"mm",sliderVal:"200",sliderMax:"1500",sliderMin:"1"}),new M({title:"层高",location:".floorHeight",unit:"mm",sliderVal:"200",sliderMax:"1500",sliderMin:"1"}),new M({title:"地板厚度",location:".floorPly",unit:"mm",sliderVal:"200",sliderMax:"1500",sliderMin:"1"})}handover(){$("#untitled").click(function(){$e.openContent(event,"unnamed","propertycontent_box_2","header_title")}),$("#floorProperties").click(function(){$e.openContent(event,"floorProperty","propertycontent_box_2","header_title")})}static roomSelect(){document.querySelector("#roomtype").addEventListener("change",function(t){$("#roomname").val(t.target.value),editor.list.setRoomType.dispatch(t.target.value)});const e=document.querySelector("#roomname");e.addEventListener("keydown",function(t){$("#roomname").val(t.target.value),editor.list.setRoomType.dispatch(t.target.value)}),e.addEventListener("blur",function(t){$("#roomname").val(t.target.value),editor.list.setRoomType.dispatch(t.target.value)})}};let se=fe;F(se,"roomTypelist",[{name:"未命名"},{name:"门厅"},{name:"客厅"},{name:"餐厅"},{name:"阳台"},{name:"卧室"},{name:"主卧"},{name:"次卧"},{name:"儿童房"},{name:"老人房"},{name:"洗衣间"},{name:"卫生间"},{name:"走廊"},{name:"厨房"}]);const A=class{constructor(){const o=document.querySelector(".mine_tabscontent"),e=document.createElement("div");e.className="mine_record tabs_content",o.appendChild(e),A.data==null?(A.newData=A.minePutmodelList,A.data=A.minePutmodelList):A.newData=A.data,A.list==null?(A.newList=A.groupIteminlineList,A.list=A.groupIteminlineList):A.newList=A.list,this.init()}static saveGroupItem(o,e,t){e==null&&(e=[]);const s=document.querySelectorAll(".save_group .group_item"),n=document.createElement("div");n.className="group_item_inline";var l=`<div class='group_item_inline_title'>
                            ...
                            <div class='group_item_inline_title_contentbox'>
                                ${e.map(m=>`<div class='save_group_item cursor '>
    ...
    </div>`;const r=document.querySelector(".mine_record"),c=document.querySelector(".mine_record_item");for(c.style.display="none",n.innerHTML=l,r.insertBefore(n,r.child),$(".return_key").click(()=>{c.style.display="block",n.remove()}),i=0;i<s.length;i++)s[i].className=s[i].className.replace("group_itembg","");c.style.display="none",document.querySelectorAll(".save_group_item").forEach((m,g)=>{m.onclick=function(){const f=e[g].json;editor.list.loadGLTFJson.dispatch(f)}});const p=document.querySelectorAll(".save_group_item_delete");let u=JSON.parse(localStorage.getItem("groupIteminlineList"));for(let m=0;m<p.length;m++){const g=p[m];g.onclick=function(f){f.stopPropagation(),u[t].splice(m,1),g.parentNode.remove(),localStorage.setItem("groupIteminlineList",JSON.stringify(u))}}}init(){this.renderView(),this.event()}renderView(){$(".mine_record").append(`<div class='mine_record_item'>
        ...
        ${A.newData.map(e=>` 
            <div class='group_item cursor'>
                ...
                </div>`).join("")}`,localStorage.setItem("saveRecorf",JSON.stringify(o)),document.querySelectorAll(".save_group .group_item").forEach((l,r)=>{let c=[],d=l.childNodes[1].innerText;l.onclick=function(){if(localStorage.getItem("groupIteminlineList")==null)c=A.groupIteminlineList;else{let p=JSON.parse(localStorage.getItem("groupIteminlineList"));p.length==0?c=A.groupIteminlineList:c=p}A.saveGroupItem(d,c[r],r),l.classList.add("group_itembg")}});let n=JSON.parse(localStorage.getItem("groupIteminlineList"));n==null&&(n=[[],[],[]]),n.push([]),localStorage.setItem("groupIteminlineList",JSON.stringify(n))}}).open()})}};let R=A;F(R,"data",JSON.parse(localStorage.getItem("saveRecorf"))),F(R,"list",JSON.parse(localStorage.getItem("groupIteminlineList"))),F(R,"groupIteminlineList",[[],[],[]]),F(R,"minePutmodelList",[{title:"全部",num:1e3},{title:"默认",num:1e3},{title:"家具组合",num:1e3}]),F(R,"newData",null),F(R,"newList",null);class co{constructor(){}main(o,e){this.renderView1(o,e)}renderView1(o,e){new ve({width:"20%",height:"200px",title:"选择分组",content:`<select class='savegroup'>${R.data.map((t,s)=>`<option value=${s}>${t.title}</option>`).join("")}</select>`,success(){let t=$(".savegroup").val();$(".savegroup").find("option:selected").text(),localStorage.getItem("groupIteminlineList")==null&&localStorage.setItem("groupIteminlineList",JSON.stringify(R.list));const s=JSON.parse(localStorage.getItem("groupIteminlineList"));s[t].push({src:o,json:e}),localStorage.setItem("groupIteminlineList",JSON.stringify(s)),document.querySelector(".group_item_inline")}}).open()}}class mo{constructor(o){this.opts=Object.assign({title:"",viewList:[],replace:!0},o);const e=document.querySelectorAll(".replaceView");for(let c=0;c<e.length;c++){const d=e[c];d.parentNode.removeChild(d)}const t=document.querySelector(".hideBarleft"),s=document.createElement("div"),n=document.createElement("div");s.className="replaceView",n.className="tier replaceDom",t.appendChild(s),s.appendChild(n);const l=document.createElement("div");l.className="replaceHeader",n.appendChild(l);const r=document.createElement("div");r.className="replaceContent",n.appendChild(r),this.init()}init(){this.renderView()}renderView(){$(".replaceHeader").append(`<div class='public_title'><span>商品替换</span><div class="closeReplace cursor ">x</div></div>
            ...
            </div>`)}event(){const o=document.querySelectorAll(".mine_put_model_button_click_item"),e=new U;o.forEach(t=>{t.onclick=function(){for(let s=0;s<o.length;s++)o[s].className=o[s].className.replace("minePutBg","");t.classList.add("minePutBg"),e.init(),document.querySelector(".mine_put_model_button_click").style.display="none"}}),$(".mine_put_model_button_click_btn").click(()=>{document.querySelector(".mine_put_model_button_click").style.display="block"})}}window.schemeContentList=[];localStorage.getItem("schemeContentList")===null?window.schemeContentList=[]:window.schemeContentList=JSON.parse(localStorage.getItem("schemeContentList"));const go=[{title:"我的收藏",type:"collect"},{title:"上传模型",type:"put"},{title:"保存记录",type:"record"}],ho=[{title:"方案",type:"scheme"},{title:"模型",type:"model"}];class be{constructor(){const o=document.getElementById("mine"),e=document.createElement("div");e.className="mine_box",o.insertBefore(e,o.child);const t=document.createElement("div");t.className="mine_header",e.insertBefore(t,e.child);const s=document.createElement("div");s.className="mine_content",e.insertBefore(s,e.child);const n=document.createElement("div");n.className="minetabs_header",s.insertBefore(n,s.child);const l=document.createElement("div");l.className="mine_tabscontent",s.insertBefore(l,s.child),$(".mine_header").append(`<span>我的</span><svg class="icon icon-min" aria-hidden="true"  height='20' width='20'>
            <use xlink:href="#icon-shousuo"></use>
            </svg>`),$(".minetabs_header").append(`${go.map(u=>`<div class='item_tabs center'>${u.title}</div>`).join("")}`),document.querySelectorAll(".item_tabs")[0].classList.add("tabs_active");const r=document.createElement("div");r.className="mine_collect tabs_content",l.insertBefore(r,l.child),document.querySelector(".mine_collect").classList.add("tabs_show");const c=document.createElement("div");c.className="mine_collect_inline",r.insertBefore(c,r.child);const d=document.createElement("div");d.className="collect_title",c.insertBefore(d,c.child),$(".collect_title").append(`${ho.map(u=>`<span class='collect_title_item center cursor'>${u.title}</span>`).join("")}`),document.querySelectorAll(".collect_title_item")[0].classList.add("collect_inline_active");const p=document.createElement("div");p.className="model_solution",c.insertBefore(p,c.child),this.init(),new po,new R,new Ae}init(){be.renderView(),this.event()}static renderView(){let o=[{title:"全部",num:1e3},{title:"默认",num:1e3},{title:"家具组合",num:1e3}];var e=[{src:"./static/assets/images/public/shafa.jpg"},{src:"./static/assets/images/public/shafa.jpg"},{src:"./static/assets/images/public/shafa.jpg"},{src:"./static/assets/images/public/shafa.jpg"},{src:"./static/assets/images/public/shafa.jpg"}];const t=document.querySelector(".model_solution"),s=document.createElement("div");s.className="mine_scheme_content collect_inline_content collect_inline_show",t.insertBefore(s,t.child),$(".mine_scheme_content").append(`<div class='mine_scheme_content_src'>
     ${window.schemeContentList.map(d=>`<div class='mine_scheme_content_src_item'>
                 <img src=${d.base64} />
                 <span class='iconfont icon-shanshu-1 delete_model_item'></span>
                 <span class='delete_model_ordername'>${JSON.parse(d.json).orderName}</span>
     </div>`).join("")}
 </div>
...
<img src='./static/assets/images/public/right_jiantou.svg'/>
 ...
 `);const n=document.createElement("div");n.className="mine_model_content collect_inline_content ",t.insertBefore(n,t.child),$(".mine_model_content").append(`<div class='model_contentbox'>
            ...
            `);const l=document.querySelectorAll(".group_item");l.forEach((d,p)=>{d.onclick=function(){let u=d.childNodes[1].innerText;const m=document.createElement("div");m.className="group_item_inline";var g=`<div class='group_item_inline_title'>
                                            <div class='return_key cursor'>
                                                <img src='./static/assets/images/jiantou.svg'/>
                                                <span class='iconfont icon-jiajuzuhe-xiankuang'></span>
                                            </div>
                ...
                </div>`;m.innerHTML=g;const f=document.querySelector(".mine_collect");f.insertBefore(m,f.child);const _=document.querySelector(".mine_collect_inline");for($(".return_key").click(()=>{_.style.display="block",m.remove()}),p=0;p<l.length;p++)l[p].className=l[p].className.replace("group_itembg","");d.classList.add("group_itembg"),_.style.display="none"}});const r=document.querySelectorAll(".mine_scheme_content_src_item");for(let d=0;d<r.length;d++){const p=r[d];p.onclick=function(){editor.list.recoveryScene.dispatch(window.schemeContentList[d].json)}}const c=document.querySelectorAll(".delete_model_item");for(let d=0;d<c.length;d++)c[d].onclick=function(p){p.stopPropagation();let u=c[d].parentNode,m=[].indexOf.call(c[d].parentNode.parentNode.childNodes,u)-1;window.schemeContentList.splice(m,1),c[d].parentNode.remove(),localStorage.setItem("schemeContentList",JSON.stringify(window.schemeContentList)),window.schemeContentList=JSON.parse(localStorage.getItem("schemeContentList"))||[]};new Ae({itemClass:".collect_title_item",itemActiveClass:"collect_inline_active",contentClass:".collect_inline_content",contentShowClass:"collect_inline_show"})}event(){}}new be;class vo{constructor(o){this.options={value:0}}init(){this.createElement()}create(o,e){let t=document.createElement(o);return t.className=e,t}createElement(){this.$PROGRESSBAR=this.createBar(),this.$PROGRESSTITLE=this.createTitle(),this.$PROGRESSBOX=this.createProgressBar(),this.$PROGRESSBAR.appendChild(this.$PROGRESSTITLE),this.$PROGRESSBAR.appendChild(this.$PROGRESSBOX),document.body.appendChild(this.$PROGRESSBAR)}createBar(){return this.$BAR=this.create("div","uploading_dialog"),this.$BAR.id="upload_dialog_pop",this.$BAR.style=`
        height: 40px;
        width: 200px;
        position : absolute;
        bottom: 50px;
        ...
        `,this.$TITLE.innerHTML="上传中...",this.$TITLE}createProgressBar(){return this.$PROGRESS=this.create("div","progress_barbox1"),this.$PROGRESSVAL=this.create("span","progress_val1"),this.$PROGRESSVAL.innerHTML=`${this.options.value}%`,this.$PROGRESS.appendChild(this.$PROGRESSVAL),this.$PROGRESS.style.width=this.options.value+"%",console.log(this.options.value),this.$PROGRESS}hide(){document.querySelector("#upload_dialog_pop").remove()}}class Ee{constructor(){}init(o,e,t,s,n){n?(document.querySelector("#cameraShot_box")&&this.close(),this.createEle(o,e,t,s)):document.querySelector("#cameraShot_box")?this.close():this.createEle(o,e,t,s)}create(o,e){let t=document.createElement(o);return t.className=e,t}createEle(o,e,t,s){this.CAMERASHOT=this.createBox(),this.SHOTBOX=this.createShot(o,e,t,s),this.CAMERASHOT.appendChild(this.SHOTBOX),document.body.appendChild(this.CAMERASHOT)}createBox(){return this.$BOX=this.create("div","camera_shot"),this.$BOX.id="cameraShot_box",this.$BOX}createShot(o,e,t,s){return this.$SHOT=this.create("div","shot_box"),this.$SHOT.style=`
            ...
            top:${s}px;
            left:${t}px;
        `,this.$SHOT}close(){document.querySelector("#cameraShot_box").remove()}}class wo{constructor(o,e,t=""){const s=document.querySelector(`#${e}`);s&&s.remove(),this.id=e,this.LineBox=document.querySelector(".shot_box"),this.x=t||this.LineBox.clientHeight/2,this.color=o,this.renderView()}renderView(){this.LineBox.style.position="relative";const o=document.createElement("div");o.id=this.id,o.style=`
        height:3px;
        width:100%;
        display:flex;
        align-items: center;
